...
//  BeacappSDKforiOS
//
//  Created by Akira Hayakawa on 2014/08/08.
 ...
 *  @param total   進捗値の最大値
 */
- (void)manager:(JBCPManager *)manager didProgressUpdateEvents:(NSNumber *)current total:(NSNumber *)total __attribute__((unavailable("manager:didProgressUpdateEvents:total: is unavailable in Version 1.0")));
 ...
 */
@optional
- (BOOL)manager:(JBCPManager *)manager shouldUpdateContents:(NSDictionary *)info __attribute__((unavailable("manager:shouldUpdateContents: is unavailable in Version 1.0")));
 ...
 *  @param total   進捗値の最大値
 */
- (void)manager:(JBCPManager *)manager didProgressUpdateContents:(NSNumber *)current total:(NSNumber *)total __attribute__((unavailable("manager:didProgressUpdateContents:total: is unavailable in Version 1.0")));
 ...
 *  @param error   エラーが発生した場合、詳細情報の NSError オブジェクトを格納する。成功した場合は nil が格納される。
 */
- (void)manager:(JBCPManager *)manager didFinishUpdateContents:(NSError *)error __attribute__((unavailable("manager:didFinishUpdateContents: is unavailable in Version 1.0")));
